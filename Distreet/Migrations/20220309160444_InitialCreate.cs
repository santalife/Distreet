        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VenueLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Root = table.Column<int>(type: "int", nullable: false),
                    FeedbackById = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    EventFeedbackId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventFeedbacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventFeedbacks_AspNetUsers_FeedbackById",
                        column: x => x.FeedbackById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EventFeedbacks_EventFeedbacks_EventFeedbackId",
                        column: x => x.EventFeedbackId,
                        principalTable: "EventFeedbacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EventLikes_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostComments_AspNetUsers_CommentById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventFeedbacks_EventFeedbackId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventFeedbacks_FeedbackById",
                table: "EventFeedbacks",
                column: "FeedbackById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventLikes_ApplicationUserId",
                table: "EventLikes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostComments_CommentById",
                table: "PostComments",
                column: "CommentById");
